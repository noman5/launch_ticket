    ...
    <body>
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="homeSubmenu">
                            ...
                            <li id="menu-academico-avaliacoes" ><a href="feedbackemap">Add Feedback</a></li>
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="pageSubmenu3">
                            ...
                            <li id="menu-arquivos" ><a href="showcartpage">Payment</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="pageSubmenu2">
                            ...
                            <li><a href="ticketView">Ticket Report with PTN</a></li>
                            <li><a href="ReportOnePassengerpassView">One Passenger Report</a></li>
                            <li><a href="LaunchCabinView">Search by Launch Report </a></li>
                            <li><a href="LaunchReport1CabinView">Search by Launch Report </a></li>
                        </ul>
                    </li>
            </nav>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="outer-w3-agile col-xl ml-xl-3 mt-xl-0 mt-3">
                            <h4 class="tittle-w3-agileits mb-4">Regular Launch Pie Chart</h4>
                            <div id="chartdiv"></div>
                        </div>
                        <!--// Pie-chart -->
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="outer-w3-agile col-xl mt-3 mx-xl-3 p-xl-0 px-md-5">
                            <div class="header">
                                <div class="text">
                                    <img src="resources/deshboardplug/images/profile.jpg" class="img-fluid rounded-circle" alt="Responsive image">
                                    <h2>Abdullah Al Noman</h2>
                                    <a href="mailto:noman.sumon52@gmail.com">
                                        <p>Owner of NS GROUP</p>
                                    </a>
                                </div>
                            </div>
        ...
        <script>
            ...
            var chartData = [{
                ...
                {
                    country: "-Dhaka-Patuakhali",
                    value: 12
                },
                {
                    country: "-Dhaka-Monpura",
                    value: 6
                },
                {
                    country: "Dhaka-Bhola",
